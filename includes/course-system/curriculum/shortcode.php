 ...
 * Shortcode [course_curriculum] para usar en cualquier parte
 * 
...
/**
 * Shortcode para mostrar curriculum
 * Uso: [course_curriculum]
 */
function course_curriculum_shortcode($atts) {
    ...
    // Verificar si el usuario compró
            ...
            ?>
                <div class="curriculum-module" style="border:1px solid rgba(218, 4, 128, 0.3);border-radius:12px;margin-bottom:15px;overflow:hidden;transition:all 0.3s;">
                    ...
                    <div class="module-header" 
                         style="padding:18px 20px;cursor:pointer;display:flex;justify-content:space-between;align-items:center;background:linear-gradient(135deg, rgba(218, 4, 128, 0.15) 0%, rgba(30, 35, 45, 0.8) 100%);transition:all 0.3s;border-bottom:1px solid rgba(218, 4, 128, 0.2);" 
                         onclick="toggleModuleShortcode(this)"
                         onmouseover="this.style.background='linear-gradient(135deg, rgba(218, 4, 128, 0.25) 0%, rgba(30, 35, 45, 0.9) 100%)'"
                         onmouseout="this.style.background='linear-gradient(135deg, rgba(218, 4, 128, 0.15) 0%, rgba(30, 35, 45, 0.8) 100%)'">
                    ...
                    <div class="module-content" style="max-height:0;overflow:hidden;transition:max-height 0.4s ease-in-out;">
                        <div class="module-lessons" style="padding:15px 20px;background:rgba(218, 4, 128, 0.05);">
                            ...
                            <?php if ($show_content) : // CONTENIDO ?>
                                <?php if (!empty($module['lessons'])) : ?>
                                    <?php foreach ($module['lessons'] as $lesson) : ?>
                                        <div class="lesson-item-display" 
                                             style="display:flex;align-items:center;gap:12px;padding:10px 0;color:#9ca3af;font-size:15px;border-bottom:1px solid rgba(218, 4, 128, 0.1);transition:all 0.2s;"
                                             onmouseover="this.style.paddingLeft='8px';this.style.color='#da0480'"
                                             onmouseout="this.style.paddingLeft='0';this.style.color='#9ca3af'">
                            ...
                            <?php else : // BLOQUEADO ?>
                                <div class="locked-content" style="padding:40px 30px;text-align:center;background:linear-gradient(135deg, rgba(218, 4, 128, 0.08) 0%, rgba(20, 25, 35, 0.6) 100%);">
                                    ...
                                    <p style="color:#6b7280;margin:10px 0 0 0;font-size:14px;">
                                        <?php if (!empty($module['lessons'])) : ?>
                                            📝 <?php echo count($module['lessons']); ?> lecciones en este módulo
                                        <?php endif; ?>
                                    </p>
                                </div>
                            <?php endif; ?>
